...
def main():
    ...
    # Using a new destination directory for these specific images
    parser.add_argument("--dest-dir", default="/home/student/12/b12902131/Desktop/BBBall-RL/env_scripts/screenshots/filtered_new", help="Destination directory")
    
    # New Bounding box defaults
    ...
    # New RGB Ranges
    parser.add_argument("--r-min", type=float, default=0.0, help="Minimum Red")
    parser.add_argument("--r-max", type=float, default=1.0, help="Maximum Red")
    parser.add_argument("--g-min", type=float, default=160.0, help="Minimum Green")
    parser.add_argument("--g-max", type=float, default=170.0, help="Maximum Green")
    parser.add_argument("--b-min", type=float, default=0.0, help="Minimum Blue")
    parser.add_argument("--b-max", type=float, default=1.0, help="Maximum Blue")
